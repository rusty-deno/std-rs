...
export function __wbg_joinhandle_free(a: number): void;
export function joinhandle_is_finished(a: number): number;
export function joinhandle_thread(a: number): number;
...
export function joinhandle_join(a: number): void;
